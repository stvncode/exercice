...
import {
  ...
  ReactExercises,
  ReactHookForm,
  ReactHookFormExercises,
  ReactHookFormIntermediate,
  ReactHookFormJunior,
  ReactHookFormSenior,
  ReactIntermediate,
  ReactJunior,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <ReactHookFormJunior />,
      },
      {
        path: "/react-hook-form/intermediate",
        element: <ReactHookFormIntermediate />,
      },
      {
        path: "/react-hook-form/senior",
        element: <ReactHookFormSenior />,
      },
      {
        path: "/react-hook-form/exercises",
        element: <ReactHookFormExercises />,
      },
    ],
  },
  {
